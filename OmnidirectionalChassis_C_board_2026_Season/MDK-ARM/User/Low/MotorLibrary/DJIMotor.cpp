...
// motor::DJIMotor M2006_205(0x205);
motor::YawMotor M6020_206;
...
void RmMotorRxData()
{
    switch (Can_RX.rxHeader.StdId)
    {
        ...
        case 0x202:
            M3508_202.DataUpdate(Can_RX.rxdata);
            break;

        case 0x203:
            M3508_203.DataUpdate(Can_RX.rxdata);
            break;
        ...
        case 0x204:
            ...
            break;
//        case 0x205:
//            M2006_205.DataUpdate(Can_RX.rxdata);
//            break;
...
void DJImotorTX_0x200(CAN_HandleTypeDef* hcan)
{
    ...
    int16_t motor2_value = (short)M3508_202.MotorSet;
    int16_t motor3_value = (short)M3508_203.MotorSet;
...
{
    int16_t motor1_value = 0;//(short)M2006_205.MotorSet;
