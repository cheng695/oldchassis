...
PID::PID_ M3508_201_PidInstance(PID::PID_::PID_MODE::PID_SPEED, 5.0f, 0.0f, 0.0f, 16384.0f, 2500.0f, 200.0f);
PID::PID_ M3508_202_PidInstance(PID::PID_::PID_MODE::PID_SPEED, 5.0f, 0.0f, 0.0f, 16384.0f, 2500.0f, 200.0f);
PID::PID_ M3508_203_PidInstance(PID::PID_::PID_MODE::PID_SPEED, 5.0f, 0.0f, 0.0f, 16384.0f, 2500.0f, 200.0f);
PID::PID_ M3508_204_PidInstance(PID::PID_::PID_MODE::PID_SPEED, 5.0f, 0.0f, 0.0f, 16384.0f, 2500.0f, 200.0f);
PID::PID_ Revolve_PidInstance(PID::PID_::PID_MODE::PID_POSITION, 2000.0f, 0.0f, 0.0f, 16384.0f, 0.0f, 0.0f);
// PID::PID_ M2006_205_PidInstance(PID::PID_::PID_MODE::PID_SPEED, 1.0f, 0.0f, 0.0f, 10000.0f, 0.0f   , 0.0f  );
